...
#define DC_MotorA_In1_Pin 41    // You can swape this pin with In2 if the motor rotation direction is not what you want
#define DC_MotorA_In2_Pin 40    // You can swape this pin with In1 if the motor rotation direction is not what you want
#define DC_MotorB_Enable_Pin 9  // Don't change this one
#define DC_MotorB_In1_Pin 43    // You can swape this pin with In2 if the motor rotation direction is not what you want
#define DC_MotorB_In2_Pin 42    // You can swape this pin with In1 if the motor rotation direction is not what you want

#define DC_MotorA_Encoder_PinA 15  // PCINT10  DON'T CHANGE THIS ONE unless you set your pin change interrupt yourself
#define DC_MotorA_Encoder_PinB 14  // PCINT9   DON'T CHANGE THIS ONE unless you set your pin change interrupt yourself
#define DC_MotorB_Encoder_PinA A15 // PCINT22  DON'T CHANGE THIS ONE unless you set your pin change interrupt yourself
#define DC_MotorB_Encoder_PinB A14 // PCINT23  DON'T CHANGE THIS ONE unless you set your pin change interrupt yourself

#define ACCEL_BUTTON 22
#define OFF_BUTTON 24
#define PAUSE_BUTTON 25
#define ON_BUTTON 26
#define DECEL_BUTTON 28
